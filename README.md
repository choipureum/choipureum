...
가장 좋아하는 언어는 Java이며 관심있는 분야는 웹 서버 개발입니다. 이유는 다른 프로그램에 비해, 많은 기능을 제공하는 웹이라는 플랫폼을 통해 내가 만든 프로그램이 다양한 기능과 서비스를 제공할 수 있기 때문입니다. <br>
저는 기술적 측면인 코딩이외에 사회공헌이나 노블리스오블리제에 대한 고찰과 관심이 많았습니다. 때문에 이와관련된 대외활동이나 봉사, 인턴경력 또한 가지고 있습니다. 그렇기 때문에 생각하는 개발자로써 궁극적으로 사회에 공헌할 수 있는 프로그램을 만드는 것이 하나의 꿈입니다.
</div>
</details>
